...
export class MaterialCreator {
    ...
    materialsInfo: Record<string, any>;
    materials: Record<string, any>;
    materialsArray: Array<any>;
    nameLookup: Record<string, any>;
    side: number;
    wrap: number;
    crossOrigin!: string;
    manager!: any;
    ...
    createMaterial_(materialName: string) {
        ...
        var resolveURL = function (baseUrl: string, url: string) {
    ...
    loadTexture(url: any, mapping?: any, onLoad?: any, onProgress?: any, onError?: any) {
        var texture;
